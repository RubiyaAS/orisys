                    ...
                    <div class="greennature-navigation-wrapper">
                        <nav class="greennature-navigation" id="greennature-main-navigation">
                            <ul id="menu-main-menu-1" class="sf-menu greennature-main-menu">
								...
								<li class="menu-item"><a href="crop_view_table.php">Crop</a></li>
								</ul>
                                </ul>
								<li class=" current-menu-item greennature-normal-menu"><a href="farmer_auction_table.php"><i class=""></i>Auction</a></li>
								<li class="menu-item menu-item-has-children greennature-normal-menu"><a href="crop_add.php" class="sf-with-ul-pre"><i class="fa fa-file-text-o"></i>Add Crop</a>
