                    ...
                    <div class="greennature-navigation-wrapper">
                        <nav class="greennature-navigation" id="greennature-main-navigation">
                            <ul id="menu-main-menu-1" class="sf-menu greennature-main-menu">
                                <li class="menu-item menu-item-home current-menu-item greennature-normal-menu"><a href="farmer_table_view.php"><i class="fa fa-home"></i>VIEW FARMERS</a>
								<ul class="sub-menu">
                                ...
                                <li class="menu-item menu-item-has-childrenmenu-item menu-item-has-children greennature-mega-menu"><a href="login.php" class="sf-with-ul-pre"><i class="fa fa-globe"></i>Logout</a>
                                    <div class="sf-mega">
